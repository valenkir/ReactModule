...
function HeroContacts() {
  ...
  return (
    <section
      className={`HeroContacts-container d-flex align-items-center ${theme}-primary-text ${theme}-bg-secondary-gradient`}
    >
      <div className={`HeroContacts-contact-block d-flex align-items-center`}>
